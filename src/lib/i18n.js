...
const VALUES_EN = {
  ...
  // Report-Ebenen (domain.json → report_ebenen)
  'Wochen-Report': 'Weekly report',
  'Monats-Report': 'Monthly report',
  'VR-Report (Quartal)': 'Board report (quarterly)',
  'Woche (GL-Weekly)': 'Week (ExB weekly)',
  'Monat (MBR)': 'Month (MBR)',
  'Quartal (VR)': 'Quarter (Board)',
  // Rollen
...
Object.assign(DICT.de, {
  ...
  'rep.titel': 'Verdichtete Reports — Woche → Monat → Quartal aus einer Datenbasis',
  'rep.untertitel': 'Kein Zusammentragen: jeder Report wird aus den erfassten Sitzungen + dem Milestone-Stand berechnet. VR-getaggte Entscheide wandern automatisch ins VR-Pack.',
  'rep.chairmanStatement': 'Chairman-Statement (optional)',
  'rep.programmKommentar': 'Programm-Kommentar (optional)',
  'rep.urteilPlaceholder': 'das Urteil, das die Daten nicht liefern …',
  'rep.kiTitle': 'Ergänzt den Report um einen klar markierten KI-ENTWURF: Narrativ zum Berichtszeitraum + 2-Satz-Begründung je gefährdetem/verzögertem Meilenstein. Ampel & Zahlen bleiben deterministisch; du gibst vor Verteilung frei.',
  'rep.kiLabel': '🤖 KI-Entwurf (Narrativ + Ampel-Begründungen)',
  'rep.erzeugtKi': 'erzeugt… (~1-2 Min mit KI)',
  'rep.erzeugt': 'erzeugt… (~15s)',
  'rep.erzeugen': 'erzeugen',
  'rep.erzeugteReports': 'Erzeugte Reports',
  'rep.neuesteZuerst': '— neueste zuerst; Quelle reports_index.json',
  'tw.keineVeraenderung': 'Keine Veränderungen im Fenster.',
  'tw.ampelWechsel': 'Ampel-Wechsel',
  'tw.fortschritt': 'Fortschritt',
  'tw.erledigteHandlungen': 'Erledigte Handlungen',
  'tw.protokolleEntscheide': 'Protokolle & Entscheide',
  'tw.evidenz': 'Evidenz (Link/Quelle)',
  'tw.fortschreiben': 'fortschreiben',
  'tw.fragePlaceholder': 'z.B. «Welche kritischen Meilensteine von Stephanie Rohde sind vor dem 31.10. fällig?»',
  'intro.alle': 'alle',
  'intro.drsEigentuemer': 'DRS — Eigentümer & Chairman:',
  'intro.afrCgo': 'AFR + CGO — treiben die Umsetzung',
  'intro.drsSteuert': 'DRS steuert & kontrolliert',
  'intro.meeting': 'MEETING',
  'intro.wann': 'WANN',
  'intro.mitWem': 'MIT WEM',
  'intro.zweck': 'ZWECK',
  'intro.output': 'OUTPUT-ERWARTUNG → WOHIN',
  'intro.traktandenliste': 'TRAKTANDENLISTE',
  'intro.grundsaetze': 'Grundsätze:',
...
Object.assign(DICT.en, {
  ...
  'rep.titel': 'Condensed reports — week → month → quarter from one data basis',
  'rep.untertitel': 'No manual collation: every report is computed from the recorded meetings and the milestone status. Board-tagged decisions move into the board pack automatically.',
  'rep.chairmanStatement': 'Chairman statement (optional)',
  'rep.programmKommentar': 'Programme comment (optional)',
  'rep.urteilPlaceholder': 'the judgement the data cannot provide …',
  'rep.kiTitle': 'Adds a clearly marked AI DRAFT to the report: narrative for the period + two-sentence rationale per at-risk/delayed milestone. Status lights and figures stay deterministic; you approve before distribution.',
  'rep.kiLabel': '🤖 AI draft (narrative + status rationales)',
  'rep.erzeugtKi': 'generating… (~1-2 min with AI)',
  'rep.erzeugt': 'generating… (~15s)',
  'rep.erzeugen': 'generate',
  'rep.erzeugteReports': 'Generated reports',
  'rep.neuesteZuerst': '— newest first; source reports_index.json',
  'tw.keineVeraenderung': 'No changes in this window.',
  'tw.ampelWechsel': 'Status changes',
  'tw.fortschritt': 'Progress',
  'tw.erledigteHandlungen': 'Completed actions',
  'tw.protokolleEntscheide': 'Minutes & decisions',
  'tw.evidenz': 'Evidence (link/source)',
  'tw.fortschreiben': 'update',
  'tw.fragePlaceholder': 'e.g. «Which critical milestones owned by Stephanie Rohde are due before 31.10.?»',
  'intro.alle': 'all',
  'intro.drsEigentuemer': 'DRS — owner & chairman:',
  'intro.afrCgo': 'AFR + CGO — drive implementation',
  'intro.drsSteuert': 'DRS steers & controls',
  'intro.meeting': 'MEETING',
  'intro.wann': 'WHEN',
  'intro.mitWem': 'WITH WHOM',
  'intro.zweck': 'PURPOSE',
  'intro.output': 'EXPECTED OUTPUT → WHERE TO',
  'intro.traktandenliste': 'AGENDA',
  'intro.grundsaetze': 'Principles:',
